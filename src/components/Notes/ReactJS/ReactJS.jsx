...
const ReactJS = () => {
    const weeks = [
        {id: 1, ttl: "Week - 1", path: "week1"},
        {id: 2, ttl: "Week - 2", path: "/notes/react-js/week2"},
        {id: 3, ttl: "Week - 3", path: "/notes/react-js/week3"},
        {id: 4, ttl: "Week - 4", path: "/notes/react-js/week4"},
    ];
